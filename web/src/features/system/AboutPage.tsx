    ...
    <PageContainer size="wide">
      ...
      <SettingsGroup title="Project">
        <div className="settings-group-content about-project">
          ...
          <p>
            Supported managed configuration: AdGuard Home v0.107.78+ patches in
            the v0.107 API generation on schema v2. v0.107.78 and v0.107.79 are
            explicitly tested; newer v0.107 patches are provisionally compatible
            after API validation. PostgreSQL 17 and Debian 13/systemd or Docker
            Compose v2 are the current reference platforms.
          </p>
          <p>
            <a
